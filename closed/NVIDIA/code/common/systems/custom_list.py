...
custom_systems['IGX_Orin_Ada6000'] = SystemConfiguration(host_cpu_conf=CPUConfiguration(layout={CPU(name="Cortex-A78AE", architecture=CPUArchitecture.aarch64, core_count=4, threads_per_core=1): 1}), host_mem_conf=MemoryConfiguration(host_memory_capacity=Memory(quantity=56.105924, byte_suffix=ByteSuffix.GB), comparison_tolerance=0.05), accelerator_conf=AcceleratorConfiguration(layout={GPU(name="NVIDIA RTX 6000 Ada Generation", accelerator_type=AcceleratorType.Discrete, vram=Memory(quantity=47.98828125, byte_suffix=ByteSuffix.GiB), max_power_limit=300.0, pci_id="0x26B110DE", compute_sm=89): 1}), numa_conf=None, system_id="IGX_Orin_Ada6000")
